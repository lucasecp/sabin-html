...
if ($('.sabin-mais-buscados').length) {
  var slideOptions = JSON.parse($(".sabin-mais-buscados").attr('carrossel-options'));
  var scrollAutomatico = slideOptions && Object.keys(slideOptions).indexOf('scrollAutomatico') !== -1 ? slideOptions.scrollAutomatico : false;
  var tempo = slideOptions && Object.keys(slideOptions).indexOf('tempo') !== -1 ? slideOptions.tempo : 3000;
  var tempoTransicao = slideOptions && Object.keys(slideOptions).indexOf('tempoTransicao') !== -1 ? Number(slideOptions.tempoTransicao) : 0.5;
  var pauseOnHover = slideOptions && Object.keys(slideOptions).indexOf('pausarNoHover') !== -1 ? slideOptions.pausarNoHover : false;
  new Splide('.carrossel-sabin-mais-buscados', {
...
/* harmony import */ var _splide__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./splide */ "./js/splide.js");
/* harmony import */ var _splide__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_splide__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _carrossel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./carrossel */ "./js/carrossel.js");
/* harmony import */ var _carrossel__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_carrossel__WEBPACK_IMPORTED_MODULE_1__);
